...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-12 xl:px-20 w-full mx-auto h-full overflow-y-scroll'>
      <h2 className="text-xl font-semibold mb-6 tezt-gray-800 dark:text-purple-100">Community Images</h2>
      {images.length > 0 ? (
        <div className='flex flex-wrap max-sm:justify-center gap-5'>
          {images.map((item, index) => (
            <a href={item.imageUrl} target='_blank' key={index}
              className='rlative group black rounded-lg overflow-hidden border border-gray-200 dark:border-purple-700 shadow-sm hover:shadow-md transition-shadow duration-300' >
